...
public class ViewFilial extends javax.swing.JInternalFrame {
 
   
    public ViewFilial() {
        initComponents();
        DefaultTableModel modelo = (DefaultTableModel) TabelaFilial.getModel();
        TabelaFilial.setRowSorter(new TableRowSorter(modelo));
        readTable();
    ...
    private void initComponents() {
        ...
        txtid_filial = new javax.swing.JFormattedTextField();
        ...
        setClosable(true);
        setTitle("ENTERPRISE - CADASTRO DAS FILIAIS");

        TabelaFilial.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED));
        TabelaFilial.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID FILIAL", "DESCRICÃO DA FILIAL", "CADASTRADO POR", "DT CADASTRO", "ALTERADO POR", "DT ALTERAÇÃO", "CANCELADO"
            }
        ) {
        ...
        TabelaFilial.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        TabelaFilial.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabelaFilialMouseClicked(evt);
            }
        });
        TabelaFilial.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TabelaFilialKeyReleased(evt);
            }
        });
        ...
        lblcodigo.setText("ID FILIAL");

        txtid_filial.setEditable(false);
        try {
            txtid_filial.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        txtid_filial.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtid_filialKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtid_filialKeyTyped(evt);
            }
        });

        lbldescricao.setText("DESCRIÇÃO OU NOME DA FILIAL");
        ...
        PainelDadosLayout.setHorizontalGroup(
            ...
            .addGroup(PainelDadosLayout.createSequentialGroup()
                ...
                .addGroup(PainelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtid_filial, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        PainelDadosLayout.setVerticalGroup(
            ...
            .addGroup(PainelDadosLayout.createSequentialGroup()
                ...
                .addComponent(lblcodigo)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtid_filial, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lbldescricao)
    ...
    private void TabelaFilialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaFilialMouseClicked
        passagemderegistros();
    }//GEN-LAST:event_TabelaFilialMouseClicked

    private void TabelaFilialKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TabelaFilialKeyReleased
        passagemderegistros();
    }//GEN-LAST:event_TabelaFilialKeyReleased
    ...
    private void txtid_filialKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtid_filialKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
          if(txtid_filial.getText().trim().length()!= 4){
             ...
             txtid_filial.requestFocus();
          } else {
              txtdescricao.requestFocus();
          }    
        }
    }//GEN-LAST:event_txtid_filialKeyPressed
    ...
    private void txtid_filialKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtid_filialKeyTyped
        String caracteres="0123456789";
        if(!caracteres.contains(evt.getKeyChar()+"")){
          evt.consume();
        }
    }//GEN-LAST:event_txtid_filialKeyTyped
    ...
    public void limparCampos() {
     ...
     public void readTableForDesc(String desc) {        
        ...
        for(Filial filial: filialdao.readForDesc(desc)){
            modelo.addRow(new Object[]{                
                filial.getId_filial(),
                filial.getDescricao(),
                filial.getUsuariocadastro(),
                df.format(filial.getDtcadastro()),
                filial.getUsuarioalteracao(),
                df.format(filial.getDtalteracao()),
                filial.getCancelado()
            });
        }
        limparCampos();
    ...
    public void readTable() {
        ...
        FilialDAO filialdao = new FilialDAO();
        DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        for(Filial filial: filialdao.read()){
            modelo.addRow(new Object[]{                
                filial.getId_filial(),
                filial.getDescricao(),
                filial.getUsuariocadastro(),
    ...
    public void readTableForCod(String codigo) {        
        ...
        FilialDAO filialdao = new FilialDAO();
        DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        for(Filial filial: filialdao.readForCod(codigo)){
            modelo.addRow(new Object[]{                
                filial.getId_filial(),
                filial.getDescricao(),
                filial.getUsuariocadastro(),
       ...
       // FilialDAO filialdao = new FilialDAO();
        ...
        if (txtdescricao.getText().trim().isEmpty()) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                filial.setDescricao(txtdescricao.getText().toUpperCase());
                filial.setUsuariocadastro(Integer.parseInt(ViewLogin.Id_Colaborador));
                filial.setDtcadastro(Util.formatarDataPostgres(dataSistema));
                filial.setUsuarioalteracao(Integer.parseInt(ViewLogin.Id_Colaborador));
                filial.setDtalteracao(Util.formatarDataPostgres(dataSistema));
                filial.setCancelado("N");
                FilialDAO.getInstance().salvar(filial);
                readTable();
            }
        }
    }
    ...
    public void atualizar() {
        if (txtdescricao.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "CAMPO CÓDIGO OU DESCRICÃO SEM PREENCHIMENTO, CORRIJA ! !", "ENTERPRISE - ATENÇÃO", JOptionPane.ERROR_MESSAGE);
            txtdescricao.requestFocus();
        } else {
            if (TabelaFilial.getSelectedRow() != -1) {
                Filial filial = new Filial();
               // FilialDAO filialdao = new FilialDAO();
                Date dataSistema = new Date();
                DateFormat formatodata = new SimpleDateFormat("dd/MM/yyyy");  
                filial.setId_filial((int) TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 0));
                filial.setDescricao(txtdescricao.getText().toUpperCase());
                
//                try {
//                    filial.setDtcadastro(((java.util.Date) formatodata.parse(txtdtcadastro.getText())));
...
//    }
     ...
     public void cancelar() {   // ESTE MÉTODO CANCELA O  REGISTRO DA FILIAL
        if (TabelaFilial.getSelectedRow() != -1) {
            Date dataSistema = new Date();
            Filial filial = new Filial();
            //FilialDAO filialdao = new FilialDAO();
...
//                    }
                    ...
                    filial.setDtalteracao(Util.formatarDataPostgres(dataSistema));
                    chkcancelado.setSelected(false);
                    // filialdao.cancelar(filial);
                    FilialDAO.getInstance().cancelar(filial); // APÓS A MIGRAÇÃO PARA O HIBERNATE É NECESSÁRIO APENAS ESTE MÉTODO
                }
            } else {
...
//                    }
    ...
    public void passagemderegistros() {
        if (TabelaFilial.getSelectedRow() != -1) {
            ...
            txtid_filial.setText(TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 0).toString());
            txtdescricao.setText(TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 1).toString());
            if (TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 2).toString().equals("0")) {
                txtusuariocadastro.setText("ADMINISTRADOR");
            } else {
                txtusuariocadastro.setText(colaboradordao.pesquisaId_Colaborador(TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 2).toString()));
            }
            txtdtcadastro.setText(TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 3).toString());
            if (TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 4).toString().equals("0")) {
                txtusuarioalteracao.setText("ADMINISTRADOR");
            } else {
                txtusuarioalteracao.setText(colaboradordao.pesquisaId_Colaborador(TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 4).toString()));
            }
            txtdtalteracao.setText(TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 5).toString());
            if (TabelaFilial.getValueAt(TabelaFilial.getSelectedRow(), 6).toString().equals("S")) {
                chkcancelado.setSelected(true);
            } else {
                chkcancelado.setSelected(false);
            }
    ...
    private javax.swing.JFormattedTextField txtid_filial;
