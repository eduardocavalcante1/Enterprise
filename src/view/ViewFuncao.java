...
public class ViewFuncao extends javax.swing.JInternalFrame {
 
   
    public ViewFuncao() {
        initComponents();
        DefaultTableModel modelo = (DefaultTableModel) TabelaFuncao.getModel();
        TabelaFuncao.setRowSorter(new TableRowSorter(modelo));
        readTable();
    }
    ...
    private void initComponents() {
        ...
        lblcomissaoperc = new javax.swing.JLabel();
        txtcomissaoperc = new javax.swing.JFormattedTextField();
        ...
        setClosable(true);
        setTitle("ENTERPRISE - CADASTRO DE FUNÇÕES");

        TabelaFuncao.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        TabelaFuncao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID FUNCÃO", "DESCRIÇÃO DA FUNÇÃO", "COMISSÃO %", "CADASTRADO POR", "DT CADASTRO", "ALTERADO POR", "DT ALTERAÇÃO", "CANCELADO"
            }
        ) {
        ...
        TabelaFuncao.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        TabelaFuncao.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TabelaFuncaoMouseClicked(evt);
            }
        });
        TabelaFuncao.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                TabelaFuncaoKeyReleased(evt);
            }
        });
        ...
        lbldescricao.setText("DESCRIÇÃO DA FUNÇÃO");
        ...
        lblcomissaoperc.setText("COMISSÃO %");

        txtcomissaoperc.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter()));
        txtcomissaoperc.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtcomissaoperc.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtcomissaopercKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtcomissaopercKeyTyped(evt);
            }
        });
            ...
            .addGroup(PainelDadosLayout.createSequentialGroup()
                ...
                .addGroup(PainelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PainelDadosLayout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addGroup(PainelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lblcomissaoperc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(txtcomissaoperc))))
        ...
        PainelDadosLayout.setVerticalGroup(
            ...
            .addGroup(PainelDadosLayout.createSequentialGroup()
                ...
                .addGroup(PainelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbldescricao)
                    .addComponent(lblcomissaoperc))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(PainelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtdescricao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtcomissaoperc, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(PainelDadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void TabelaFuncaoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TabelaFuncaoKeyReleased
        passagemderegistros();
    }//GEN-LAST:event_TabelaFuncaoKeyReleased
    ...
    private void txtcomissaopercKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcomissaopercKeyTyped
        String caracteres="0123456789.,%";
        if(!caracteres.contains(evt.getKeyChar()+"")){
          evt.consume();
        }
    }//GEN-LAST:event_txtcomissaopercKeyTyped

    private void txtcomissaopercKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcomissaopercKeyPressed
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
           btnincluir.requestFocus();
        }
    }//GEN-LAST:event_txtcomissaopercKeyPressed
    ...
    public void readTable() {
        ...
        for (Funcao funcao : funcaodao.read()) {
            modelo.addRow(new Object[]{
                funcao.getId_funcao(),
                funcao.getDescricao(),
                funcao.getComissaoperc(),
                funcao.getUsuariocadastro(),
                df.format(funcao.getDtcadastro()),
                funcao.getUsuarioalteracao(),
                df.format(funcao.getDtalteracao()),
                funcao.getCancelado()
            });
        }
        limparCampos();
    ...
    public void readTableForDesc(String desc) {
        ...
        FuncaoDAO funcaodao = new FuncaoDAO();
        DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
        for (Funcao funcao : funcaodao.readForDesc(desc)) {
            modelo.addRow(new Object[]{
                funcao.getId_funcao(),
                funcao.getDescricao(),
                funcao.getComissaoperc(),
    ...
    public void incluir() {
        ...
        if (txtdescricao.getText().trim().isEmpty()) {
            ...
            if (resposta == JOptionPane.YES_OPTION) {
                funcao.setDescricao(txtdescricao.getText().toUpperCase());
                if (txtcomissaoperc.getText().trim().isEmpty()) {
                    funcao.setComissaoperc(Double.parseDouble("0.00"));
                } else {
                    funcao.setComissaoperc(Double.parseDouble(Util.formatarDecimalUs(txtcomissaoperc.getText())));
                }
                funcao.setUsuariocadastro(Integer.parseInt(ViewLogin.Id_Colaborador));
                funcao.setDtcadastro(Util.formatarDataPostgres(dataSistema));
                funcao.setUsuarioalteracao(Integer.parseInt(ViewLogin.Id_Colaborador));
                funcao.setDtalteracao(Util.formatarDataPostgres(dataSistema));
                funcao.setCancelado("N");
                //funcaodao.create(funcao);
                FuncaoDAO.getInstance().salvar(funcao);
                readTable();
            }
        }
    }
    ...
    public void atualizar(){
        ...
        if (txtdescricao.getText().trim().isEmpty()){
            ...
            if (TabelaFuncao.getSelectedRow() != -1 ) {
               funcao.setDescricao(txtdescricao.getText().toUpperCase());
               if (txtcomissaoperc.getText().trim().isEmpty()){
                  funcao.setComissaoperc(Double.parseDouble("0.00"));
               } else {
               ...
               funcao.setId_funcao((int)TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(),0));
               funcao.setUsuarioalteracao(Integer.parseInt(ViewLogin.Id_Colaborador));
               funcao.setDtalteracao(Util.formatarDataPostgres(dataSistema));
...
//    }
     ...
     public void cancelar() {   // ESTE MÉTODO CANCELA O REGISTRO DA FUNCAO
        if (TabelaFuncao.getSelectedRow() != -1) {
            Date dataSistema = new Date();
            Funcao funcao = new Funcao();
            FuncaoDAO funcaodao = new FuncaoDAO();
            if (chkcancelado.isSelected()) {
                ...
                if (resposta == JOptionPane.YES_OPTION) {
                    ...
                    funcao.setDtalteracao(Util.formatarDataPostgres(dataSistema));
                    chkcancelado.setSelected(false);
                   // funcaodao.cancelar(funcao);
                   FuncaoDAO.getInstance().cancelar(funcao);
                }
           } else {
    ...
    public void passagemderegistros(){
        if (TabelaFuncao.getSelectedRow()!= -1){
            ...
            txtdescricao.setText(TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 1).toString());
           // txtcomissaoperc.setText(TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 2).toString());
            txtcomissaoperc.setText(decimalBR.format(Double.parseDouble((TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 2).toString()))));
           
            if (TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 3).toString().equals("0")) {
                txtusuariocadastro.setText("ADMINISTRADOR");
            } else {
                txtusuariocadastro.setText(colaboradordao.pesquisaId_Colaborador(TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 3).toString()));
            }
            txtdtcadastro.setText(TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 4).toString());
            if (TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 5).toString().equals("0")) {
                txtusuarioalteracao.setText("ADMINISTRADOR");
            } else {
                txtusuarioalteracao.setText(colaboradordao.pesquisaId_Colaborador(TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 5).toString()));
            }
            txtdtalteracao.setText(TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 6).toString());
            if (TabelaFuncao.getValueAt(TabelaFuncao.getSelectedRow(), 7).toString().equals("S")) {
                chkcancelado.setSelected(true);
            } else {
                chkcancelado.setSelected(false);
            }
    ...
    private javax.swing.JLabel lblcomissaoperc;
    ...
    private javax.swing.JFormattedTextField txtcomissaoperc;
