...
@Table(name = "funcao")  //  @Table Permite definir o nome da tabela à qual essa entidade estará relacionada no banco de dados. Contudo, essa anotação é necessária apenas se houver diferença entre o nome da tabela e o nome da classe, como ocorre nesse caso;
public class Funcao implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "funcao_id_funcao_seq", sequenceName = "seq_funcao_id_funcao", allocationSize = 1, initialValue = 1)
    @GeneratedValue(generator = "funcao_id_funcao_seq", strategy = GenerationType.SEQUENCE)
    @Column(name="id_funcao", nullable = false)
    private int    id_funcao;
    @Column(name = "descricao", length = 45, nullable = false)
    private String descricao;
    @Column(name = "comissaoperc", nullable = false)
    ...
    public void setComissaoperc(Double comissaoperc) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id_funcao != other.id_funcao) {
            return false;
        }
        return true;
    }
